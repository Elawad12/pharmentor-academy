...
const courseFormSchema = z.object({
  ...
  isSple: z.boolean().default(false),
});
...
export default function NewCoursePage() {
  ...
  function onSubmit(data: CourseFormValues) {
    ...
    addDoc(coursesCol, data)
      .then(() => {
        toast({
          title: "تم إنشاء الكورس بنجاح!",
          description: `تمت إضافة كورس "${data.name}" إلى المنصة.`,
        });
        router.push("/courses");
      })
      .catch((serverError) => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <Card className="rounded-2xl custom-shadow">
        <CardHeader>
          <CardTitle className="text-2xl font-bold">إضافة كورس جديد</CardTitle>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              />
                ...
                />
              <Button type="submit" size="lg" className="font-bold rounded-lg" disabled={form.formState.isSubmitting}>إضافة الكورس</Button>
            </form>
          </Form>
        </CardContent>
      </Card>
